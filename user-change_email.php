        ...
        <script type="text/javascript">
            $(document).ready(function() {
                $('form#change-email').validate({
                    ...
                    messages: {
                        new_email: {
                            required: '<?php echo osc_esc_js(__("Email: this field is required", "sahara")); ?>.',
                            email: '<?php echo osc_esc_js(__("Invalid email address", "sahara")); ?>.'
                        }
                    },
            ...
            <div class="col-md-9">
                <div class="wraps">
                    <div class="cat-box-title">
                        <h1 class="judul"><?php _e("Change your e-mail", 'sahara'); ?></h1>
