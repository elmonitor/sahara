...
<section id="footer">
    <div class="footer-top">
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-sm-6 ari-12">
                    <div class="col-md-12 cat-link">
                        <h3><?php echo osc_get_preference('judul1-us', 'sahara'); ?></h3>
                        <?php echo osc_get_preference('footer-us1', 'sahara'); ?>
                        <br> </div>
                </div>
                <div class="col-md-6 col-sm-6 ari-12">
                    <div class="col-md-4 col-sm-12 cat-link">
                        <h3><?php echo osc_get_preference('judul2-us', 'sahara'); ?></h3>
                        <?php echo osc_get_preference('footer-us2', 'sahara'); ?> </div>
                    <div class="col-md-4 col-sm-12 page-link">
                        <h3><?php _e("Social Network", 'sahara'); ?></h3>
                        <ul class="pages">
                            ...
                            <li>
                                <div class="icon-box"><a target="_blank" class="btn btn-circle btn-lg-light btn-sm" href="<?php echo osc_get_preference('twitter-us', 'sahara'); ?>"><i class="fa fa-twitter-square text-dark"></i> <?php _e("TWITTER", 'sahara'); ?></a> </div>
                            </li>
                            <?php } ?>
                            ...
                            <li>
                                <div class="icon-box"> <a target="_blank" class="btn btn-circle btn-lg-light btn-sm" href="<?php echo osc_get_preference('gplus-us', 'sahara'); ?>"><i class="fa fa-google-plus-square text-dark"></i> <?php _e("GOOGLE PLUS", 'sahara'); ?></a> </div>
                            </li>
                            <?php } ?>
                            <?php if(osc_get_preference('linkedin-us', 'sahara')!='' ) { ?>
                            <li>
                                <div class="icon-box"> <a target="_blank" class="btn btn-circle btn-lg-light btn-sm" href="<?php echo osc_get_preference('linkedin-us', 'sahara'); ?>"><i class="fa fa-linkedin-square text-dark"></i> <?php _e("LINKEDIN", 'sahara'); ?></a> </div>
                            </li>
                            <?php } ?>
                            <?php if(osc_get_preference('youtube-us', 'sahara')!='' ) { ?>
                            <li>
                                <div class="icon-box"> <a target="_blank" class="btn btn-circle btn-lg-light btn-sm" href="<?php echo osc_get_preference('youtube-us', 'sahara'); ?>"><i class="fa fa-youtube text-dark"></i> <?php _e("YOUTUBE", 'sahara'); ?></a> </div>
                            </li>
                            <?php } ?> </ul>
                    </div>
                    <div class="col-md-4 col-sm-12 account-link hidden-sm">
                        <h3><?php _e("My account", 'sahara') ; ?></h3>
                        <ul class="pages">
