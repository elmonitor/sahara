                ...
                <form class="form-signin" name="sendfriend" action="<?php echo osc_base_url(true); ?>" method="post">
                    <fieldset>
                        ...
                        <div class="cat-box-title">
                            <h1 class="judul"><?php _e("Send to a friend", 'sahara'); ?></h1>
                            <div class="stripe-line"></div>
                        </div>
                        <label>
                            <?php _e("Listing", 'sahara'); ?>:
                        ...
                        <label for="friendName">
                            <?php _e("Your friend's name", 'sahara'); ?> </label>
                        <?php SendFriendForm::friend_name(); ?>
                        <br />
                        <label for="friendEmail">
                            <?php _e("Your friend's e-mail address", 'sahara'); ?> </label>
